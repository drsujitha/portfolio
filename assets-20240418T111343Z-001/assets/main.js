...
(function() {
	...
	// Initialize "On Visible" animations.
		onvisible.add('.image.style3', { style: 'zoom-in-image', speed: 1000, intensity: 5, threshold: 3, delay: 0, state: true, replay: false });
		onvisible.add('.image.style1', { style: 'zoom-out-image', speed: 750, intensity: 5, threshold: 3, delay: 0, state: true, replay: true });
		onvisible.add('h1.style5, h2.style5, h3.style5, p.style5', { style: 'fade-down', speed: 750, intensity: 0, threshold: 3, delay: 0, state: true, replay: false });
		onvisible.add('h1.style1, h2.style1, h3.style1, p.style1', { style: 'blur-in', speed: 1000, intensity: 5, threshold: 3, delay: 0, state: true, replay: false });
		onvisible.add('.container.style1', { style: 'fade-in', speed: 1000, intensity: 0, threshold: 3, delay: 0, state: true, replay: true });
		onvisible.add('.container.style1 > .wrapper > .inner', { style: 'fade-in', speed: 1000, intensity: 5, threshold: 3, delay: 500, state: true, replay: true });
		onvisible.add('.icons.style1', { style: 'fade-up', speed: 375, intensity: 3, threshold: 2, delay: 0, state: true, replay: true });
		onvisible.add('#container02', { style: 'fade-in', speed: 1000, intensity: 0, threshold: 3, delay: 0, state: true, replay: true });
		onvisible.add('#container02 > .wrapper > .inner', { style: 'fade-in', speed: 1000, intensity: 5, threshold: 3, delay: 500, state: true, replay: true });
		onvisible.add('#text12', { style: 'blur-in', speed: 1000, intensity: 5, threshold: 3, delay: 0, state: true, replay: false });
